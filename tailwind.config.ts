...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "gradient-hero": "linear-gradient(135deg, #0f1e0c 0%, #1e3818 30%, #285022 60%, #35662c 100%)",
        ...
        "gradient-cta": "linear-gradient(135deg, #285022 0%, #1e3818 50%, #0f1e0c 100%)",
        "gradient-btn": "linear-gradient(135deg, #5a9e42 0%, #498535 100%)",
