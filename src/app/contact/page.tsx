      ...
      <section className="section-padding">
        <div className="container-wide">
          <div className="grid md:grid-cols-3 gap-6">
            {/* Book Online */}
            <div className="bg-white rounded-[8px] p-8 shadow-card text-center border-t-2 border-green-400">
        ...
        <div className="container-narrow">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.label} className="flex items-start gap-4 bg-white rounded-[8px] p-6 shadow-card">
      ...
      <section className="section-padding">
        <div className="container-wide">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="rounded-[8px] overflow-hidden shadow-card aspect-video">
              <iframe
