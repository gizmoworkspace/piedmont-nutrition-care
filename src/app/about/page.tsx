      ...
      <section className="relative bg-gradient-hero overflow-hidden min-h-[50vh] sm:min-h-[55vh] max-h-[700px] flex items-center">
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-8 md:px-12 lg:px-20 py-20 sm:py-24 md:py-32 lg:py-36 w-full relative z-10">
          <div className="max-w-2xl lg:max-w-3xl">
            ...
            <p className="text-[0.95rem] sm:text-base md:text-lg text-white/65 leading-relaxed max-w-xl lg:max-w-2xl animate-fade-in-up-delay-1">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12 stagger-children">
            {[
              ...
              <AnimateOnScroll key={item.title} className="h-full">
                <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-10 shadow-card border border-warm-100/50 hover:shadow-lifted transition-shadow duration-300 group h-full flex flex-col">
                  <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-green-50 flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-green-100 transition-colors">
                    <item.icon className="w-5 h-5 sm:w-7 sm:h-7 text-green-600" />
                  </div>
                  <h3 className="font-heading text-base sm:text-lg md:text-xl text-warm-900 mb-3">{item.title}</h3>
      ...
      <section className="section-padding bg-warm-50">
        <div className="container-narrow text-center">
          <AnimateOnScroll>
            ...
            <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-[2.75rem] text-warm-950 mb-10 tracking-tight leading-[1.1]">Take the Next Step</h2>
