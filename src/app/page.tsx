          ...
          <div className="relative">
            ...
            <div className="max-w-3xl md:max-w-[50%]">
              <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-white leading-[1.2] md:leading-[1.15] mb-6 md:mb-8 animate-fade-in-up drop-shadow-lg tracking-tight">
                You deserve to eat better, feel better, and live better.{" "}
                <span className="text-green-300">Let&apos;s find out what&apos;s been holding you back.</span>
              </h1>
              <p className="text-lg md:text-xl text-green-100/90 leading-relaxed mb-8 max-w-2xl animate-fade-in-up-delay-1">
                <span className="hidden md:inline">We help you find and eat better versions of the foods you love so you can improve your health deliciously, one bite at a time. Piedmont Nutrition Care uses clinical food science to understand your gut, rebalance your metabolism, and build a person-centered plan your body actually responds to.</span>
                <span className="md:hidden">We help you find better versions of the foods you love so you can improve your health deliciously, one bite at a time.</span>
              </p>
        ...
        <div className="container-wide">
          <AnimateOnScroll>
            <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl text-warm-950 mb-14 tracking-tight text-center max-w-3xl mx-auto">
              You&apos;ve been trying so hard. Let&apos;s figure out what&apos;s really going on.
            </h2>
          </AnimateOnScroll>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 stagger-children">
            <AnimateOnScroll className="h-full">
              <div className="bg-white rounded-2xl p-6 md:p-8 border border-warm-100/50 shadow-card h-full">
                ...
                <h3 className="font-heading text-lg text-warm-900 mb-3">When your body isn&apos;t cooperating</h3>
                <p className="text-warm-600 leading-relaxed text-sm">
                  <span className="hidden md:inline">Your A1C keeps creeping up. Your stomach bloats after meals, no matter how carefully you eat. You&apos;re dealing with digestive issues that make everyday life harder than it should be.</span>
                  <span className="md:hidden">Rising A1C, bloating after meals, and digestive issues that make everyday life harder.</span>
                </p>
              </div>
            </AnimateOnScroll>
            <AnimateOnScroll className="h-full">
              <div className="bg-white rounded-2xl p-6 md:p-8 border border-warm-100/50 shadow-card h-full">
                ...
                <h3 className="font-heading text-lg text-warm-900 mb-3">When nothing seems to work</h3>
                <p className="text-warm-600 leading-relaxed text-sm">
                  <span className="hidden md:inline">You&apos;ve tried program after program, and it&apos;s easy to start thinking your body is just &ldquo;broken.&rdquo; But here&apos;s the thing — it&apos;s not about willpower or discipline. You have plenty of both. The approach just wasn&apos;t right for you.</span>
                  <span className="md:hidden">You&apos;ve tried program after program. But it&apos;s not about willpower — the approach just wasn&apos;t right for you.</span>
                </p>
              </div>
            </AnimateOnScroll>
            <AnimateOnScroll className="h-full">
              <div className="bg-white rounded-2xl p-6 md:p-8 border border-warm-100/50 shadow-card h-full">
                ...
                <h3 className="font-heading text-lg text-warm-900 mb-3">What&apos;s actually going on</h3>
                <p className="text-warm-600 leading-relaxed text-sm">
          ...
          <div className="max-w-2xl mx-auto text-center space-y-6">
            <AnimateOnScroll>
              <p className="text-warm-800 leading-relaxed font-medium text-lg">
                It&apos;s not that you haven&apos;t tried hard enough. You&apos;ve been doing your best with the information you had.
              </p>
            </AnimateOnScroll>
            <AnimateOnScroll delay={100}>
              <p className="text-warm-500 leading-relaxed italic">
                You deserve someone who takes the time to really listen and look at the whole picture — not just a quick appointment that ends with &ldquo;eat less, move more.&rdquo;
              </p>
            </AnimateOnScroll>
          </div>
        </div>
        ...
        <div className="container-wide relative z-10">
          <AnimateOnScroll animation="scale-up">
            <p className="font-heading text-2xl md:text-3xl lg:text-5xl text-white text-center leading-snug max-w-3xl mx-auto tracking-tight">
              You&apos;re not broken.
              <br />
              <span className="text-green-300">You just need the right plan — and the right partner.</span>
            </p>
          </AnimateOnScroll>

          <AnimateOnScroll delay={200}>
            <p className="text-green-200/60 text-center text-base md:text-lg mt-6 max-w-xl mx-auto">
              When we focus on quality — not quantity — your body knows what to do.
            </p>
          </AnimateOnScroll>
        </div>
      </section>
      ...
      <section className="section-padding bg-cream">
        <div className="max-w-7xl mx-auto">
          <AnimateOnScroll>
            ...
            <p className="text-warm-500 text-center mb-16 text-lg max-w-xl mx-auto">Person-centered care to meet your goals and needs</p>
          </AnimateOnScroll>
        ...
        <div className="container-wide">
          <AnimateOnScroll>
            <h2 className="font-heading text-2xl md:text-3xl lg:text-4xl text-warm-950 mb-12 text-center tracking-tight">
              There&apos;s a better way — and it doesn&apos;t mean giving up the foods you love.
            </h2>
          </AnimateOnScroll>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch">
              ...
              <div className="bg-warm-100/60 rounded-2xl p-6 md:p-8 border border-warm-200/40 opacity-80 h-full flex flex-col">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="font-heading text-lg text-warm-600 uppercase tracking-widest">Sound Familiar?</h3>
                </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-narrow">
          ...
          <div className="space-y-8">
            {[
              {
                q: "\"I've tried everything. Nothing works for me.\"",
                a: "We hear this a lot, and we want you to know — your body isn't broken. It's been responding to years of one-size-fits-all advice that wasn't designed for you. When your gut health is off, cravings intensify and blood sugar becomes harder to manage, no matter how disciplined you are. The problem was never your effort. It was the approach. We're here to help you find what actually works — for your body, your life, your goals.",
                aShort: "Your body isn't broken — it's been responding to one-size-fits-all advice. We're here to help you find what actually works for your body, your life, your goals.",
          ...
          <AnimateOnScroll className="mt-14">
            <div className="relative bg-gradient-cta text-white rounded-2xl p-8 md:p-12 text-center overflow-hidden">
              ...
              <p className="text-lg leading-relaxed text-green-50 relative z-10 max-w-2xl mx-auto">
                <span className="hidden md:inline">You&apos;ve been patient long enough. You deserve to understand what&apos;s going on in your body and have a clear path forward. The sooner we start working together, the sooner you can eat better, feel better, and live better. The next step isn&apos;t another app or another 30-day challenge — it&apos;s a real conversation with someone who will listen.</span>
                <span className="md:hidden">You&apos;ve been patient long enough. The next step isn&apos;t another app — it&apos;s a real conversation with someone who will listen.</span>
              </p>
            </div>
          </AnimateOnScroll>
        </div>
