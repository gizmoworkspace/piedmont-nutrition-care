  ...
  return (
    <>
      ...
      <section className="relative section-padding bg-gradient-to-br from-green-950 via-green-900 to-green-800 overflow-hidden grain-overlay">
        ...
        <div className="container-wide relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-green-100/90 leading-relaxed animate-fade-in-up-delay-1">{subheadline}</p>
          </div>
        </div>
      ...
      <section className="relative section-padding bg-gradient-to-br from-green-50 via-cream to-amber-50 overflow-hidden">
        ...
        <div className="container-wide relative z-10">
          <AnimateOnScroll>
            <h2 className="font-heading text-3xl md:text-4xl text-warm-950 mb-8 text-center">
              How It Works
            </h2>
          </AnimateOnScroll>
          <div className="space-y-6 text-warm-600 leading-relaxed text-lg max-w-4xl mx-auto">
